...
public class PoiResource {
	...
	public ResponseEntity<List<Poi>> listaPoiProximo(@RequestParam(value = "x", defaultValue = "1") Integer x,
	...
	public ResponseEntity<Void> cadastraPoi(@Valid @RequestBody Poi poi) {
		...
		URI uri = ServletUriComponentsBuilder.fromCurrentRequest().path("/{id}").buildAndExpand(objResponse.getId())
				.toUri();
